...
/*   Updated: 2019/10/26 12:13:14 by tmaluh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
void	ft_putstr(char const *const s) NON_NULL((1));

/*
**	Put \param s string to stdout followed by newline.
*/
void	ft_putendl(char const *const s) NON_NULL((1));
...
*/
void	ft_putstr_fd(char const *const s, int32_t const fd) NON_NULL((1));

/*
**	Put \param s string to specified \param fd output followed by newline.
*/
void	ft_putendl_fd(char const *s, int32_t const fd) NON_NULL((1));
...
*/
bool	ft_putfile(char const *const file) NON_NULL((1));
