...
/*   Updated: 2019/12/23 20:52:13 by tmaluh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
void
ft_putnchar(int32_t c, size_t n);
...
*/
extern void
ft_putchar_fd(int32_t c, int32_t fd);
...
*/
void
ft_putstr_fd(const char *restrict s, int32_t fd);

/*
**	Put \param s string to specified \param fd output followed by newline.
*/
void
ft_putendl_fd(const char *restrict s, int32_t fd);

/*
**	Put number \param n
*/
void
ft_putnbr_fd(int64_t n, int32_t fd);
