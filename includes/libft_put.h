...
/*   Updated: 2019/12/18 20:02:53 by tmaluh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
void		ft_putstr(const char *LFT_RESTRICT LFT_NONNULL s);

/*
**	Put \param s string to stdout followed by newline.
*/
extern void	ft_putendl(const char *LFT_RESTRICT LFT_NONNULL s);
...
*/
void		ft_putendl_fd(const char *LFT_RESTRICT LFT_NONNULL s, int32_t fd);
...
*/
bool		ft_putfile(const char *LFT_RESTRICT LFT_NONNULL filename);
